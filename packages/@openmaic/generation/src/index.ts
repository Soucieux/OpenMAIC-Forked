...
export { normalizeConfiguratorConfig, renderConfiguratorHtml } from './configurator-renderer.js';
export type { NormalizedConfiguratorConfig } from './configurator-renderer.js';
